...
public final class CrawlResult {
   ...
   *
   * <p>Whencomputing these counts for a given crawl, results from the same page are never
   * counted twice.
   *
   ...
   *
   * <p>Whencomputing this value for a given crawl, the same URL is never counted twice.
   */
