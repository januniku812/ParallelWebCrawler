...
public final class CrawlerConfiguration {
   ...
   * {@linkcom.udacity.webcrawler.WebCrawler} implementation, for example
   ...
   *
   * <p>See {@linkcom.udacity.webcrawler.json.CrawlResult#getWordCounts()} for more information.
   */
   ...
   * <p>If the path is empty, the data will be written to standard output.
   *
   * <p>See {@linkcom.udacity.webcrawler.json.CrawlResult}.
   */
  ...
  public static final class Builder {
    ...
    /**
     * Adds a regular expression pattern that defines words to ignore whencomputing the popular
     * counts.
     *
     * <p>Does nothing if the same pattern has already been added. See {@link #getIgnoredWords()}.
     *
     * <p>See {@linkcom.udacity.webcrawler.json.CrawlResult#getWordCounts()} for more information
     * about the popular wordcomputation.
     *
     * @param patterns one or more regular expressions that define a valid {@link Pattern}.
     */
    ...
    /**
     * Overrides the {@linkcom.udacity.webcrawler.WebCrawler} implementation that should be used
     * for the crawl.
     *
