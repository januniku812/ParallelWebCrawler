...
public final class SequentialWebCrawler implements WebCrawler {
  ...
  SequentialWebCrawler(
      ...
      @com.udacity.webcrawler.Timeout Duration timeout,
      @com.udacity.webcrawler.PopularWordCount int popularWordCount,
      @com.udacity.webcrawler.MaxDepth int maxDepth,
